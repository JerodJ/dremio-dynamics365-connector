...
@SourceType(value = "Dynamics365ARP", label = "Dynamics365",uiConfig = "dynamics365-layout.json")
public class Dynamics365Conf extends AbstractArpConf<Dynamics365Conf> {
  private static final String ARP_FILENAME = "arp/implementation/dynamics365-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.dynamics365.Dynamics365Driver";
